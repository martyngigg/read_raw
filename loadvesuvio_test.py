...
class LoadVesuvio(object):
    ...
    def getProperty(self, name):
        class PropertyWithValue(object):
            value = None

        pv = PropertyWithValue()
        pv.value = self.properties[name]
        return pv
...
#----------------------------------------------------------------------------------------
    ...
    def _load_diff_mode_parameters(self, workspace):
        ...
        """
        load_parameter_file = AlgorithmManager.create("LoadParameterFile")
...
loader = LoadVesuvio()
loader.setProperty("Filename", "20598")
loader.setProperty("SpectrumList", "3-134")
loader.setProperty("SumSpectra", True)
loader.setProperty("Mode", "SingleDifference")
loader.setProperty("InstrumentParFile", "")
loader.setProperty("OutputWorkspace", "sum_ws")
loader.run()